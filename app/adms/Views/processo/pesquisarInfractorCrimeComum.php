...
<div class="content p-1">
 ...
 //   $this->Dados = $this->Dados[0];
  ...
  // executa o que vc quer
    ...
    <form  name="SendPesquisaInfractorCrimeComum" class="form-inline" method="POST" action="<?php echo URLADM . "consultapor-crime-comum/pesquisar-crime-comum";?>">
        ...
        <input type="submit" class="btn btn-info" value="Pesquisar" name="SendPesquisaInfractorCrimeComum">
    </form>   <br><br>
