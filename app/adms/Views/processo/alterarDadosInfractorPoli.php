...
<div class="content p-1">
    <div class="list-group-item">
        ...
        <hr>
        <form name="EditInfractorPoli" action="" method="post" enctype="multipart/form-data">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-2">
                    ...
                    <input type="text"  class="form-control" name="numero_bi" pattern="[0-9]{9}[A-Z]{2}[0-9]{3}$" placeholder="Nº Bilhete" maxlength="14" value="<?php
                ...
                <div class="form-group col-md-2.1">
                    ...
                    <input type="date" pattern="[0-9]{2}\/[0-9]{2}\/[0-9]{4}$" min="1940-01-01" max="2001-01-01"  class="form-control" name="data_nascimento" placeholder="" value="<?php
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-2.5">
                   ...
                   <select name="cod_unidade_polical" id="sexo" class="form-control" required="">
                        <option value="">Selecione a Unidade Policial</option>
                        <?php
                        foreach ($this->Dados['select']['unid'] as $uni) {
                            extract($uni);
                            if ($valorForm['cod_unidade_polical'] == $id) {
