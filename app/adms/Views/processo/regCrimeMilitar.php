        ...
        <form method="POST" action="" enctype="multipart/form-data"> 
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    <label><span class="text-danger">*</span> Nome do Crime Militar</label>
                    <input name="descricao_crime_militar" type="text" class="form-control" placeholder="Escreva o Crime Militar" value="<?php
