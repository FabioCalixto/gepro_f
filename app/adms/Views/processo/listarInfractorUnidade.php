<div class="well">
    ...
    <div class="page-header">
        <h1>Consultar Infractor Por Unidade</h1>
    </div>
    <?php
    ...
    <form  name="CadPesquisaInfractor" class="form-inline" method="POST" action="<?php echo URL . "controle-infractor/pesquisar-infractor"; ?>">
            ...
            <div class="col-sm-3">
                <select class="form-control" name="name">
                    ...
                    foreach ($vis->getResultado() as $unidades):
                        extract($unidades);
                    ?>
                     <option value="<?php echo $unidades['id']; ?>"  ><?php echo $unidades['designacao_Unidade']; ?></option><?php
                    endforeach;
                endif;
                    ?>
                </select> 
...
<!--  <input type="text" name="name" class="form-control" placeholder="Nome do Usuário">-->
        ...
        <input type="submit" class="btn btn-info" value="Pesquisar" name="SendPesquisaInfractor">
    </form>  
