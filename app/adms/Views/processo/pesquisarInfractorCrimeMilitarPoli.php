...
<div class="content p-1">
 ...
 //   $this->Dados = $this->Dados[0];
  ...
  // executa o que vc quer
    ...
    <form  name="SendPesquisaInfractorCrimeMilitarPoli" class="form-inline" method="POST" action="<?php echo URLADM . "consultapor-crime-militar-poli/pesquisar-crime-militar-poli";?>">
        ...
        <input type="submit" class="btn btn-info" value="Pesquisar" name="SendPesquisaInfractorCrimeMilitarPoli">
    </form>   <br>
