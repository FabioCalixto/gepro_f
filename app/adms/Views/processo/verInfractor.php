...
if (!empty($this->Dados['dados_infractor'][0])) {
    ...
    <div class="content p-1">
        <div class="list-group-item">
             <a href="<?php echo URLADM; ?>carregar-infractores-js/listarInfractoresJs" align="right" title="Fechar Pagina">
                <div class="p-2">
                ...
                <div class="p-2">
                    ...
                    <div class="dropdown d-block d-md-none">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="acoesListar"> 
                            <?php
                            if ($this->Dados['botao']['list_infract']) {
                                echo "<a class='dropdown-item' href='" . URLADM . "carregar-infractores-js/listarInfractoresJs'>Listar</a>";
                            }
            ...
            ?>
               ...
               <a href="<?php echo URLADM; ?>detalhe-pdf/detalhes-pdf/<?php echo $id; ?>" align="right">
                <div class="p-2">
