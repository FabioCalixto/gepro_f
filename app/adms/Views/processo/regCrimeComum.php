        ...
        <form method="POST" action="" enctype="multipart/form-data"> 
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    <label><span class="text-danger">*</span> Nome do Crime Comum</label>
                    <input name="descricao_crimecomum" type="text" class="form-control" placeholder="Escreva o Crime Comum" value="<?php
