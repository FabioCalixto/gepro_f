...
<div class="content p-1">
 ...
 //   $this->Dados = $this->Dados[0];
  ...
  // executa o que vc quer
    ...
    <form  name="SendPesquisaInfractorProcessoPoli" class="form-inline" method="POST" action="<?php echo URLADM . "consulta-processo-poli/pesquisar-processo-poli";?>">
        ...
        <input type="submit" class="btn btn-info" value="Pesquisar" name="SendPesquisaInfractorProcessoPoli">
    </form>   <br><br>
