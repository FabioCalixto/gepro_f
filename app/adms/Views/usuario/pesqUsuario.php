    ...
    <div class="list-group-item">
        ...
        <form class="form-inline" method="POST" action="">
            <div class="form-group">
                <label>Nome</label>
                <input name="nome" type="text" id="nome" class="form-control mx-sm-3" placeholder="Nome do usuário" value="<?php if (isset($_SESSION['pesqUsuarioNome'])){
            ...
            <div class="form-group">
                <label>E-mail</label>
                <input name="email" type="text" id="email" class="form-control mx-sm-3" placeholder="E-mail do usuário" value="<?php if (isset($_SESSION['pesqUsuarioEmail'])){
