              ...
              <!-- R.PARAMETROS -->
                <div class="tab-pane fade show active" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                    ...
                    <form name="CadProcesso" action="" method="post" enctype="multipart/form-data" >
                        ...
                        <div class="form-row" id="patente_policia" style="display:none;">

                            <div class="form-group col-md-3.1">

                                <label><span class="text-danger">*</span> Patente:</label>
                                <select class="form-control" name="cod_posto_policia">
                                    <option value="">Selecione o Grau Policial</option>
                                    <?php
                                    $vis = new \App\adms\Models\helper\AdmsRead();
                                    $vis->ExeRead('adms_postos_policia');

                                    foreach ($vis->getResultado() as $patentes):
                                        extract($patentes);
                                        $idP = $patentes['id'];
                                        $pat = $patentes['patente_policia'];
                        ...
                        <div class="form-row" id="unidade_policial" style="display:none;">
                            <div class="form-group col-md-3.1">
                                <label><span class="text-danger">*</span> Unidade Policial:</label>
                                <select class="form-control" name="cod_unidade_policial">
...
//alert(valor);
            ...
            if (valor == 6) {
//alert(valor);
                $('#patente_policia').show();
            } else {
                $('#patente_policia').hide();
            }

            if (valor == 7) {
//alert(valor);
                $('#unidade_policial').show();
            } else {
                $('#unidade_policial').hide();
            }
