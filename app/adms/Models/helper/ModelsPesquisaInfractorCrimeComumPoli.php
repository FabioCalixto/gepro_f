 ...
 */
class ModelsPesquisaInfractorCrimeComumPoli {
    ...
    public function pesquisarInfractoresP($PageId = null, $Dados = null) {
        ...
        elseif (!empty($this->Dados['name'])):
            $this->pesquisarInfractoresCrimeComumPoli();
    ...
    private function pesquisarInfractoresPComp() {
        $Paginacao = new \App\adms\Models\helper\ModelsPaginacao(URLADM . 'consultapor-crime-comum-poli/pesquisar-crime-comum-poli/', 'name=' . $this->Dados['name']);
    ...
    private function pesquisarInfractoresCrimeComum() {
        $Paginacao = new ModelsPaginacao(URLADM . 'consultapor-crime-comum-poli/pesquisar-crime-comum-poli/', 'name=' . $this->Dados['name']);
        $Paginacao->condicao($this->PageId, 1);
        $this->ResultadoPaginacao = $Paginacao->paginacaoFullRead("SELECT
