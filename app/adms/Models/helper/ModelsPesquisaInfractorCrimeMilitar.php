 ...
 */
class ModelsPesquisaInfractorCrimeMilitar {
    ...
    public function pesquisarInfractoresP($PageId = null, $Dados = null) {
        ...
        elseif (!empty($this->Dados['name'])):
            $this->pesquisarInfractoresCrimeMilitar();
    ...
    private function pesquisarInfractoresPComp() {
        $Paginacao = new \App\adms\Models\helper\ModelsPaginacao(URLADM . 'consultapor-crime-militar/pesquisar-crime-militar/', 'name=' . $this->Dados['name']);
    ...
    private function pesquisarInfractoresCrimeMilitar() {
        $Paginacao = new ModelsPaginacao(URLADM . 'consultapor-crime-militar/pesquisar-crime-militar', 'name=' . $this->Dados['name']);
        $Paginacao->condicao($this->PageId, 1);
        $this->ResultadoPaginacao = $Paginacao->paginacaoFullRead("SELECT
