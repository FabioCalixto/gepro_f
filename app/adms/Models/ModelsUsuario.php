 ...
 *
 * @copyright (c) year, Fábio Calixto - FAMA
 */
class ModelsUsuario {
...
public function listarCrimesPorNatureza() {
        
        $Listar = new ModelsRead();
        $Listar->fullRead('SELECT COUNT(tab_infratores.id_crime_comum) AS quantidadeInfractores,adms_crime_comum.descricao_crimecomum As crime FROM tab_infratores INNER JOIN adms_crime_comum ON tab_infratores.id_crime_comum = adms_crime_comum.id GROUP BY tab_infratores.id_crime_comum');
        if (!empty($Listar->getResultado()) ):
